...
var moduleFunction = function(args) {
		...
		if (lookupControl.type == 'list') {
			...
			switch (lookupControl.finalDataName) {
				...
				case 'schools':
					...
					var query = "select schoolCode as datum from <!StudentBase!> group by schoolCode";
	...
	try {
		var profileName=self.dataSource.serverProfile;
		this.serverProfile = require(serverProfilePath + profileName);
	} catch (e) {
		var profileName='defaultServerProfile/';
		this.serverProfile = require(serverProfilePath + profileName);
	}
	...
	global.localEnvironment.log.debug({
		lightningPipe: {
			source: 'mssqlAccessor.processQuery',
			data: {
				message:'Found Server Profile: '+profileName
			}
		}
	});
