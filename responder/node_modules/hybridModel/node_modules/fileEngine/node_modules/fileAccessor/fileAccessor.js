...
var moduleFunction = function(args) {
	...
	var goGetIt = function() {
		...
		var lookupControl = self.lookupControl;
			...
			lookupControl.dataLocation=updateDistrictName(lookupControl.dataLocation);
	...
	var updateDistrictName = function(dataLocationString) {
		var districtName = dataLocationString.match(/^\/(.*?)\//);
		if (!districtName){
			var districtName = dataLocationString.match(/^\/(.*?)$/);
		}
		var databaseName = self.serverProfile.mapDistrictAccessName(districtName[1]);
		return dataLocationString.replace(new RegExp("^/" + districtName[1]), '/' + databaseName);
	}
